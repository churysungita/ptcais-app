        ...
        <main>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <a class="datcard my-3" href="">
                            <span style="color:white;" class="h4">Name:Mussa Shabani</span>
                            <br/>
                            <h6></h6>
                            <h6></h6>
                    ...
                    <div class="col-md-4">
                        <a class="datcard my-3" href="">
                            <span style="color:white;" class="h4">Region name: Dodoma</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a class="datcard my-3" href="../district_edu/view_schools.html">
