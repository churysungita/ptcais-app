...
<head>
    ...
    <title>Dashboard - PTCAIS Head Teacher</title>
...
<nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#0F2036; height: 90px;">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="{{ url('head_teacher') }}"></a>
    <!-- Sidebar Toggle-->

    <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>

    <div class="co-md-12 mt-3 py-3">
...
<div id="layoutSidenav">
    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color:#0F2036;">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="{{ url('head_teacher') }}">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ url('add_pupil') }}">Add Pupil</a>
                            <a class="nav-link" href="{{ url('transfer_requests') }}">Transfer requests</a>
                            <a class="nav-link" href="{{ url('transfer_to') }}">Transfer To</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ url('manage_teacher') }}">Manage Teacher</a>
    ...
    <!-- three -->
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ url('head_teacher_reset') }}">Change Password</a>
