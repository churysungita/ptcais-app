...
<nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#0F2036; height: 90px;">
    ...
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="{{ url('deo_dashboard') }}"></a>
    <!-- Sidebar Toggle-->
...
<div id="layoutSidenav">
    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color:#0F2036;">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="{{ url('deo_dashboard') }}">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ url('pending_transfer') }}">Manage transfer</a>
    ...
    <!-- three -->
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ url('deo_password_reset') }}">Change Password</a>
                        </nav>
                    </div>
